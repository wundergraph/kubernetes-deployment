    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <h2 className={styles.subTitle}>
          ... with{" "}
          <a href="https://wundergraph.com?utm_source=nextjs_starter">
            WunderGraph
          </a>
        </h2>
        ...
        <div className={styles.grid}>
          ...
          <a
            href="https://wundergraph.com/discord?utm_source=nextjs_starter"
            target="_blank"
            className={styles.card}
          >
            <h3>Feedback &rarr;</h3>
        ...
        <a
          href="https://wundergraph.com/demo?utm_source=nextjs_starter"
          target="_blank"
          className={styles.card}
        >
          <h3>Book a Meeting with the Makers of WunderGraph &rarr;</h3>
          <p>
            Talk to the Founders, learn more about our tool and let us help you
